                            ...
                            <form action="{{ route('pelanggan.tambah') }}" method="POST" class="capitalize">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="cabang" id="cabang"
                                        ...
                                        required>
                                        <option value="telu buyung">telu buyung</option>
                                        ...
                                        <option value="pondok hijau">rawa tembaga</option>
                                    </select>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label for="kelompok_pelanggan" class="block text-xl font-medium text-gray-700">kelompok pelanggan</label>
