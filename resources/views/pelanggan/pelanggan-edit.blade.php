            ...
            <form action="{{ route('pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="cabang" id="cabang"
                        ...
                        <option value="telu buyung"
                            @if ($pelanggan->cabang == 'telu buyung') {
                            {{ 'selected' }}
                        } @endif>
                            telu buyung</option>
                ...
                <div class="mb-4">
                    <label for="nama" class="block text-sm font-medium text-gray-700">Tanggal pelanggan</label>
                    <input type="text" name="nama" id="nama" class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required value="{{ $pelanggan->nama }}">
                </div>
                <div class="mb-4">
                    <label for="alamat" class="block text-sm font-medium text-gray-700">Total pelanggan</label>
                    <input type="text" name="alamat" id="alamat" class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required value="{{ $pelanggan->alamat }}">
                </div>
                <div class="mb-4">
                    <label for="no_telepon" class="block text-sm font-medium text-gray-700">no_telepon</label>
                    <input type="number" name="no_telepon" id="no_telepon" class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required value="{{ $pelanggan->no_telepon }}">
                </div>
                <div class="mb-4">
                ...
                <div class="btn flex gap-2">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 text-white p-2 rounded-md hover:bg-blue-700">update</button>
                </div>
            </form>
        </div>
