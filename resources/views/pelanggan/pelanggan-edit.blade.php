    ...
    <div class="bg-gray-100 flex items-center justify-center min-h-screen">
        <div class="bg-white p-8 rounded-lg shadow-md max-w-md ">
            ...
            <form action="{{ route('pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="nama" class="block text-xl font-medium text-gray-700">Tanggal pelanggan</label>
                    <input type="text" name="nama" id="nama" class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" required value="{{ $pelanggan->nama }}">
                </div>
                <div class="mb-4">
                    <label for="alamat" class="block text-xl font-medium text-gray-700">Total pelanggan</label>
                    <input type="text" name="alamat" id="alamat" class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" required value="{{ $pelanggan->alamat }}">
                </div>
                <div class="mb-4">
                    <label for="no_telepon" class="block text-xl font-medium text-gray-700">no_telepon</label>
                    <input type="number" name="no_telepon" id="no_telepon" class="mt-1 block w-full p-2 border-2 border-gray-300 rounded-md shadow-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-xl" required value="{{ $pelanggan->no_telepon }}">
                </div>
                <div class="mb-4">
